...
module.exports = function (file, opts) {
    return new Promise((resolve, reject) => {
        ...
        opts.fpage = opts.fpage || defaultOptions.fpage;
        opts.lpage = opts.lpage || defaultOptions.lpage;
        ...
        if (opts.page) {
            ...
            args.push(['-l']);
            args.push([parseInt(opts.page)]);
        }else if (opts.fpage && opts.lpage) {
            args.push(['-f']);
            args.push([parseInt(opts.fpage)]);
            args.push(['-l']);
            args.push([parseInt(opts.lpage)]);
        }
        if (opts.scale) {
            args.push(['-scale-to']);
